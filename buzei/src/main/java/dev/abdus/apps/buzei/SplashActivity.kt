...
class SplashActivity : ComponentActivity() {
    ...
    private var previewRenderer: BuzeiRenderer? = null
...
private fun SplashScreen(
    onSetWallpaper: () -> Unit,
    onCreateRenderer: (BuzeiRenderer, PreviewSurfaceView) -> Unit,
        ...
        AndroidView(
            factory = { context ->
                PreviewSurfaceView(context).apply {
                    ...
                    val renderer = BuzeiRenderer(object : BuzeiRenderer.Callbacks {
